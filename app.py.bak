...
market_rows = {
    ...
    "외국인 동향": f"코스피 순매수 {fmt_billion_krw(market_over.get('foreign_net_kospi_억원'))} / 코스닥 순매수 {fmt_billion_krw(market_over.get('foreign_net_kosdaq_억원'))}<br><span class='flat'>현재 공개 연결 데이터는 순매수 기준입니다.</span>",
    "기관 동향": f"코스피 순매수 {fmt_billion_krw(market_over.get('inst_net_kospi_억원'))} / 코스닥 순매수 {fmt_billion_krw(market_over.get('inst_net_kosdaq_억원'))}<br><span class='flat'>현재 공개 연결 데이터는 순매수 기준입니다.</span>",
}
...
with right:
    ...
    <div class="link-list">
      ...
      <a href="https://www.youtube.com/channel/UCdwlSE2aW2VCCQIS5aJwTsA" target="_blank">시동위키</a>
      <a href="https://www.youtube.com/@3protv" target="_blank">삼프로TV</a>
      <a href="https://www.youtube.com/@lucky_tv" target="_blank">김작가TV</a>
      <a href="https://www.youtube.com/@weolbu_official" target="_blank">월급쟁이부자들 TV</a>
      <a href="https://www.youtube.com/@buiknam_tv" target="_blank">부읽남TV</a>
      <a href="https://www.khan.co.kr/economy" target="_blank">경향신문 경제섹션</a>
      <a href="https://www.hani.co.kr/arti/economy/" target="_blank">한겨레 경제섹션</a>
    </div>
    ''', unsafe_allow_html=True)
